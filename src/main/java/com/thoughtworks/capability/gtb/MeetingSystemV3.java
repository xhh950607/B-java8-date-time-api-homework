...
public class MeetingSystemV3 {
    ...
    public static void main(String[] args) {
        ...
        //将伦敦时间转换成北京时间
        meetingTime = transformZone(meetingTime, ZoneId.of("Europe/London"), ZoneId.systemDefault());
        ...
        if (now.isAfter(meetingTime)) {
            ...
            //将北京时间转换为芝加哥时间
            meetingTime = transformZone(meetingTime, ZoneId.systemDefault(), ZoneId.of("America/Chicago"));
    ...
    private static LocalDateTime transformZone(LocalDateTime time, ZoneId origin, ZoneId target) {
        return ZonedDateTime.of(time, origin)
